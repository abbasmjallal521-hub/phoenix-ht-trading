...
.btn-outline { width: 100%; padding: 11px; border-radius: 12px; background: transparent; border: 1px solid #F5C451; color: #F5C451; font-weight: 800; font-size: 13px; }
...
.avatar-box { width: 80px; height: 80px; border-radius: 50%; background: #1A2232; overflow: hidden; margin: 0 auto 12px; border: 2px solid #F5C451; padding: 8px; }
...
.vip-item { font-size: 12px; color: #CBD5E1; display: flex; align-items: center; gap: 10px; font-weight: 600; margin-bottom: 6px; }
.vip-item::before { content: '✓'; color: #F5C451; font-weight: 900; }
.btn-gold { width: 100%; padding: 14px; border-radius: 12px; background: linear-gradient(135deg, #F5C451 0%, #D4AF37 100%); border: none; color: #000; font-weight: 900; font-size: 14px; }
...
.nav-tab { border: none; background: transparent; color: #6C7D93; padding: 6px; border-radius: 12px; font-weight: 700; font-size: 10px; display: flex; flex-direction: column; align-items: center; gap: 4px; }
...
<div class="app-viewport">
  <div class="app-header">
    <div class="header-brand">
      <div class="phoenix-logo-box">
        <svg viewBox="0 0 100 100" style="width:100%; height:100%;">
          <defs><linearGradient id="pGoldGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#FFE082"/><stop offset="40%" stop-color="#F5C451"/><stop offset="80%" stop-color="#E28B00"/><stop offset="100%" stop-color="#8A4B00"/></linearGradient></defs>
          <rect x="25" y="8" width="3" height="18" fill="url(#pGoldGrad)" rx="1"/><rect x="23" y="12" width="7" height="10" fill="url(#pGoldGrad)" rx="1"/><rect x="33" y="14" width="2" height="16" fill="url(#pGoldGrad)" rx="1"/><rect x="31" y="18" width="6" height="9" fill="url(#pGoldGrad)" rx="1"/>
          <rect x="72" y="8" width="3" height="18" fill="url(#pGoldGrad)" rx="1"/><rect x="70" y="12" width="7" height="10" fill="url(#pGoldGrad)" rx="1"/><rect x="65" y="14" width="2" height="16" fill="url(#pGoldGrad)" rx="1"/><rect x="63" y="18" width="6" height="9" fill="url(#pGoldGrad)" rx="1"/>
          <path d="M50 22 C44 22, 40 28, 44 34 L50 44 L56 34 C60 28, 56 22, 50 22 Z" fill="url(#pGoldGrad)"/><path d="M50 18 L53 25 L47 25 Z" fill="url(#pGoldGrad)"/><path d="M50 42 L32 25 L18 36 L30 48 L50 72 L70 48 L82 36 L68 25 Z" fill="url(#pGoldGrad)"/>
          <path d="M22 38 L8 46 L24 54 L36 44 Z" fill="url(#pGoldGrad)"/><path d="M78 38 L92 46 L76 54 L64 44 Z" fill="url(#pGoldGrad)"/><path d="M26 50 L14 58 L30 64 L40 54 Z" fill="url(#pGoldGrad)"/><path d="M74 50 L86 58 L70 64 L60 54 Z" fill="url(#pGoldGrad)"/><path d="M50 68 L44 80 L50 88 L56 80 Z" fill="url(#pGoldGrad)"/>
        </svg>
      </div>
      <div>
    ...
    <button class="icon-btn" onclick="switchTab('profile')">🔔</button>
  </div>
  ...
  <div id="tab-home" class="tab-page">
    ...
    <div class="sec-title">Latest Signal <button onclick="switchTab('signals')">View All →</button></div>
    <div class="sig-card">
      <div class="sig-head"><div class="sig-pair">XAUUSD <span class="badge-dir buy">BUY</span></div><div class="badge-status active">ACTIVE</div></div>
      <div class="sig-grid"><div class="sig-cell"><label>Entry</label><val>3648.00</val></div><div class="sig-cell"><label>SL</label><val>3642.00</val></div><div class="sig-cell"><label>TP1</label><val>3654.00</val></div><div class="sig-cell"><label>TP2</label><val>3660.00</val></div></div>
    </div>
    <div class="sec-title">Latest Analysis <button onclick="switchTab('analysis')">View All →</button></div>
    <div class="an-card">
      <div class="an-title">Gold Analysis - 5M</div>
      <div class="an-meta">XAUUSD | 5M • 4h ago</div>
      <div class="an-desc">Gold is showing strong bullish momentum above the key support zone targeting 3670.</div>
  ...
  <div id="tab-analysis" class="tab-page hidden">
    ...
    <div class="an-card"><div class="an-title">Gold Analysis - 5M</div><div class="an-meta">XAUUSD | 5M • 4h ago</div><div class="an-desc">Detailed market breakdown and support zones.</div></div>
  </div>

  <!-- CHAT -->
  <div id="tab-chat" class="tab-page hidden">
    <div class="sec-title" style="margin-top:0;">Questions / Chat</div>
    <div style="background:#111723; padding:14px; border-radius:16px; margin-bottom:10px;">
      <div style="font-weight:800; font-size:13px; margin-bottom:6px;">👤 Ahmad</div>
      <div style="font-size:13px; color:#CBD5E1; margin-bottom:8px;">Why did we enter Buy on XAUUSD?</div>
      <div style="background:#080C14; padding:10px; border-radius:8px; font-size:12px; color:#F5C451;">💬 Bullish Fair Value Gap respected.</div>
    </div>
  </div>
  ...
  <div id="tab-profile" class="tab-page hidden">
    <div class="profile-card">
      <div class="avatar-box">
        <svg viewBox="0 0 100 100" style="width:100%; height:100%;"><path d="M50 22 C44 22, 40 28, 44 34 L50 44 L56 34 C60 28, 56 22, 50 22 Z" fill="#F5C451"/><path d="M50 42 L32 25 L18 36 L30 48 L50 72 L70 48 L82 36 L68 25 Z" fill="#F5C451"/></svg>
      </div>
      <div class="profile-name">Abbas Mjallal</div>
      <div class="profile-handle">@abbasmj</div>
      <div style="font-size:11px; background:#1A2232; color:#F5C451; padding:4px 14px; border-radius:12px; display:inline-block; font-weight:800;">Free Plan</div>
    </div>
    <div class="vip-box">
      <div class="vip-title">👑 VIP Coming Soon</div>
      <div style="font-size:12px; color:#8A97A8; margin-bottom:10px;">Get premium signals and advanced analysis.</div>
      <div class="vip-item">VIP Signals (higher accuracy)</div>
      <div class="vip-item">Advanced Analysis</div>
      <button class="btn-gold" onclick="alert('Subscribed to waitlist!')">Notify Me</button>
    </div>
...
function switchTab(tab) {
  ['home', 'signals', 'analysis', 'chat', 'profile'].forEach(t => {
