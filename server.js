...
// مصفوفة التوصيات والبيانات الأولية
const signals = [
  {
    id: "sig-1",
    symbol: "XAUUSD",
...
// دوال بناء الكروت في السيرفر (Server-Side Rendering)
...
.app-viewport { max-width: 440px; margin: 0 auto; padding: 16px 16px 100px; }

/* Top Header */
.app-header { display: flex; align-items: center; justify-content: space-between; padding: 8px 0 16px; }
.header-brand { display: flex; align-items: center; gap: 12px; }
.phoenix-logo-box { width: 44px; height: 44px; border-radius: 14px; background: linear-gradient(145deg, #2A2215 0%, #110E08 100%); border: 1px solid rgba(245, 196, 81, 0.4); display: grid; place-items: center; box-shadow: 0 4px 20px rgba(245, 196, 81, 0.25); }
.phoenix-svg { width: 32px; height: 32px; }
...
.icon-btn { width: 40px; height: 40px; border-radius: 12px; background: #111723; border: 1px solid rgba(255,255,255,0.08); color: #F5C451; display: grid; place-items: center; font-size: 18px; cursor: pointer; border: none; }
...
.sec-title button { background: none; border: none; color: #F5C451; font-size: 12px; font-weight: 700; cursor: pointer; }
...
/* Signal Card */
.sig-card { background: #111723; border: 1px solid rgba(255,255,255,0.08); border-radius: 18px; padding: 16px; margin-bottom: 12px; cursor: pointer; box-shadow: 0 6px 20px rgba(0,0,0,0.25); transition: 0.2s; }
...
.btn-gold { width: 100%; padding: 14px; border-radius: 12px; background: linear-gradient(135deg, #F5C451 0%, #D4AF37 100%); border: none; color: #000; font-weight: 900; font-size: 14px; cursor: pointer; box-shadow: 0 4px 15px rgba(245, 196, 81, 0.3); }
...
.nav-bottom-bar { position: fixed; bottom: 0; left: 50%; transform: translateX(-50%); width: min(440px, 100%); padding: 10px 12px 14px; background: rgba(8, 12, 20, 0.96); backdrop-filter: blur(16px); border-top: 1px solid rgba(255,255,255,0.08); display: grid; grid-template-columns: repeat(5, 1fr); gap: 4px; z-index: 100; }
